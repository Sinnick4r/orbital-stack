...
make test                               # 97 tests, expect all green
...
DVC (storage only) · pytest · ruff · mypy strict
...
**v0.1.0** (April 2026) — Phase 1 complete: weekly OrbitWatch pipeline
validated end-to-end against live UNOOSA data (24,866 rows). See
[CHANGELOG.md](./CHANGELOG.md).

**Roadmap**:

- **v0.2.0** — `orbital.quality.expectations` with drift and
  cardinality checks.
